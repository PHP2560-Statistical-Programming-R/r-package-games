...
blackjack() allows you to play Black Jack in the R command window. 

The user first indicates whether they want a hand or if they want to input their own hand. Since Black Jack only depends on the value of each card, the user will receive the values of their card (2-10, where 10 can be either from the card 10, King, or Queen). 

If the user receives an Ace, this will be indicated by the card 13, and they will be asked to then set a binding value for Ace. They are then asked if they'd like to continue drawing. 
